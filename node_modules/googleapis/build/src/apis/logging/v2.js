...
(function (logging_v2) {
    ...
    class Resource$Billingaccounts$Buckets$Views {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    logging_v2.Resource$Billingaccounts$Buckets$Views = Resource$Billingaccounts$Buckets$Views;
    ...
    class Resource$Billingaccounts$Operations {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    logging_v2.Resource$Billingaccounts$Operations = Resource$Billingaccounts$Operations;
