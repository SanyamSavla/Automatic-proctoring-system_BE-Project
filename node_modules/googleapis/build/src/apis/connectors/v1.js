...
(function (connectors_v1) {
    ...
    class Resource$Projects$Locations$Global {
        constructor(context) {
            this.context = context;
            this.providers = new Resource$Projects$Locations$Global$Providers(this.context);
        }
    }
    connectors_v1.Resource$Projects$Locations$Global = Resource$Projects$Locations$Global;
    class Resource$Projects$Locations$Global$Providers {
        constructor(context) {
            this.context = context;
            this.connectors =
                new Resource$Projects$Locations$Global$Providers$Connectors(this.context);
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
    ...
    connectors_v1.Resource$Projects$Locations$Global$Providers = Resource$Projects$Locations$Global$Providers;
    class Resource$Projects$Locations$Global$Providers$Connectors {
        constructor(context) {
            this.context = context;
            this.versions =
                new Resource$Projects$Locations$Global$Providers$Connectors$Versions(this.context);
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
    ...
    connectors_v1.Resource$Projects$Locations$Global$Providers$Connectors = Resource$Projects$Locations$Global$Providers$Connectors;
    class Resource$Projects$Locations$Global$Providers$Connectors$Versions {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    connectors_v1.Resource$Projects$Locations$Global$Providers$Connectors$Versions = Resource$Projects$Locations$Global$Providers$Connectors$Versions;
