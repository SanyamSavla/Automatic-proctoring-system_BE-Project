...
export declare namespace recommender_v1beta1 {
    ...
    export class Resource$Organizations$Locations$Insighttypes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        config(params: Params$Resource$Organizations$Locations$Insighttypes$Config, options: StreamMethodOptions): GaxiosPromise<Readable>;
        config(params?: Params$Resource$Organizations$Locations$Insighttypes$Config, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecommenderV1beta1InsightTypeConfig>;
        config(params: Params$Resource$Organizations$Locations$Insighttypes$Config, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        config(params: Params$Resource$Organizations$Locations$Insighttypes$Config, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1InsightTypeConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1InsightTypeConfig>): void;
        config(params: Params$Resource$Organizations$Locations$Insighttypes$Config, callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1InsightTypeConfig>): void;
        config(callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1InsightTypeConfig>): void;
        /**
    ...
    export interface Params$Resource$Organizations$Locations$Insighttypes$Config extends StandardParameters {
        /**
         * Name of insight type config. Eg, projects/[PROJECT_NUMBER]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]/config
         */
        name?: string;
    ...
    export class Resource$Organizations$Locations$Recommenders {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        config(params: Params$Resource$Organizations$Locations$Recommenders$Config, options: StreamMethodOptions): GaxiosPromise<Readable>;
        config(params?: Params$Resource$Organizations$Locations$Recommenders$Config, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecommenderV1beta1RecommenderConfig>;
        config(params: Params$Resource$Organizations$Locations$Recommenders$Config, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        config(params: Params$Resource$Organizations$Locations$Recommenders$Config, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1RecommenderConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1RecommenderConfig>): void;
        config(params: Params$Resource$Organizations$Locations$Recommenders$Config, callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1RecommenderConfig>): void;
        config(callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1beta1RecommenderConfig>): void;
        /**
    ...
    export interface Params$Resource$Organizations$Locations$Recommenders$Config extends StandardParameters {
        /**
         * Name of recommender config. Eg, projects/[PROJECT_NUMBER]/locations/[LOCATION]/recommenders/[RECOMMENDER_ID]/config
         */
        name?: string;
